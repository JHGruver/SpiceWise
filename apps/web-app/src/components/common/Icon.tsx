...
const icons: Record<IconName, JSX.Element> = {
  ...
  cooking: (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <path d="M12 3c-1.5 0-3 .5-3 2v2h6V5c0-1.5-1.5-2-3-2z" />
  ...
  stomach: (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <path d="M12 2c3 0 6 2 6 6v4c0 4-2 8-6 10-4-2-6-6-6-10V8c0-4 3-6 6-6z" />
  ...
  cards: (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      ...
      <path d="M14 8h6a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2h-6" />
      <path d="M6 10h4" />
      <path d="M6 14h4" />
    </svg>
  ),
...
export default function Icon({ name, size = 'md', className = '' }: IconProps) {
  ...
  return (
    <span className={`icon icon--${size} icon--${name} ${className}`}>
      {icon}
    </span>
  )
}
